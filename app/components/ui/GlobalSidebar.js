  ...
  return (
    <>
      ...
      <div className={`md:hidden fixed inset-0 z-[10000] transition-opacity duration-300 ${isSidebarOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        ...
        />
        <aside className={`fixed top-[4.25rem] right-0 h-[calc(100%-4.25rem)] w-80 bg-white shadow-xl transform transition-transform duration-300 ease-in-out z-[10001] overflow-y-auto ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}>
