                ...
                <tr key={x.id} className={`border-t ${!x.parentId ? 'bg-amber-300' : (!x.isOrderable ? 'bg-gray-100' : '')}`}>
                  ...
                  <td className="p-2">
                    <div className="flex items-center gap-2 rtl:space-x-reverse">
                      ...
                      <Link href={`/dashboard/supplier/products/${x.id}/edit`} className="px-2 py-1 rounded border text-xs hover:bg-slate-50">ویرایش</Link>
                      <Link href={`/dashboard/supplier/products/${x.id}/report`} className="px-2 py-1 rounded border text-xs hover:bg-slate-50 text-blue-700 border-blue-200">گزارش</Link>
          ...
          {displayRows.map((x)=> (
            <div key={x.id} className={`p-3 border-b border-gray-200 ${!x.parentId ? 'bg-amber-50' : (!x.isOrderable ? 'bg-gray-50' : '')}`}>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link href={`/dashboard/supplier/products/${x.id}/edit`} className="px-3 py-1 rounded border text-xs hover:bg-slate-50 bg-white">ویرایش</Link>
                <Link href={`/dashboard/supplier/products/${x.id}/report`} className="px-3 py-1 rounded border text-xs hover:bg-slate-50 text-blue-700 border-blue-200 bg-white">گزارش</Link>
