  ...
  return (
    <div className="p-4 md:p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <Link href="/dashboard/user-management/users" className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:bg-slate-50">
        ...
        <Link href="/dashboard/farmer/orders" className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:bg-slate-50">
        ...
        <Link href="/cart" className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:bg-slate-50">
