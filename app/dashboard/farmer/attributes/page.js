              ...
              {defs.map((d) => (
                <tr key={d.id} className="border-t">
                  ...
                  <td className="p-2 flex gap-3">
                    <Link href={`/dashboard/farmer/attributes/${d.id}/view`} className="text-blue-600">{t("view")}</Link>
                    <Link href={`/dashboard/farmer/attributes/${d.id}/edit`} className="text-amber-600">{t("edit")}</Link>
          ...
          {defs.map((d) => (
            <div key={d.id} className="p-3 border-b border-gray-200">
              ...
              <div className="flex flex-wrap gap-2">
                <Link href={`/dashboard/farmer/attributes/${d.id}/view`} className="px-3 py-1 rounded border text-xs hover:bg-slate-50 bg-white text-blue-600">{t("view")}</Link>
                <Link href={`/dashboard/farmer/attributes/${d.id}/edit`} className="px-3 py-1 rounded border text-xs hover:bg-slate-50 bg-white text-amber-600">{t("edit")}</Link>
