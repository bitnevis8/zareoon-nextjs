    ...
    <main className="max-w-6xl mx-auto px-3 sm:px-6 py-10 space-y-8">
      ...
      <section className="text-center space-y-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
          {t("agriculturalProducts")}
        </h1>
        
        <p className="text-gray-600 max-w-2xl mx-auto">
          {t("agriculturalProductsDesc")}
        </p>
                  ...
                  <div className="mt-3">
                    ...
                    <div className="space-y-2">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="stock-type-label">
                                {child.isOrderable ? t('product') : t('category')}
                              </span>
                            </div>
                          </Link>
                        );
                      ...
                      {(childrenMap[category.id] || []).length > 4 && (
                        ...
                        >
                          <span className="text-sm font-medium">{t("viewAll")} ({childrenMap[category.id]?.length || 0})</span>
                        </Link>
                      )}
